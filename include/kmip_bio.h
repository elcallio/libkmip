...
int kmip_bio_get_symmetric_key_with_context_ex(KMIP *, BIO *, char *, int, char **, int *, enum cryptographic_algorithm*);
...
int kmip_bio_get_attributes_with_context(KMIP *ctx, BIO *bio, char *uuid, int uuid_size, const char **attr_names, int n_attr_names, Attribute **attrs, int *n_attrs);
